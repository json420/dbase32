...
from dbase32 import b32enc, sb32enc
from collections import namedtuple

Tup = namedtuple('Tup', 'i data hex b32 sb32')
...
print('    =============  ===========  ===========')
print('       Binary         Base32       S-Base32')
print('    =============  ===========  ===========')
for (a, b, c) in zip(sort1, sort2, sort3):
    print('    {:>2} {}  {:>2} {}  {:2} {}'.format(a.i, a.hex, b.i, b.b32, c.i, c.sb32))
print('    =============  ===========  ===========')
